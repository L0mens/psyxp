...
<div id="mrs-2-1" class="consigne hidden">
    <h2>Questionnaire</h2>
    <span>2/2</span>
    <button id ="btn-suivant-mrs-2-1" class="btn-suivant-consigne" onclick="switchConsigne('mrs','2-2')">Suivant</button>
</div>
...
<div id="mrs-2-4" class="consigne hidden">
    ...
    <button id ="btn-suivant-mrs-2-4" class="btn-suivant-consigne" onclick="startSecondPreuve()">Suivant</button>
</div>
