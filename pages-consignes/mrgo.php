...
<div id="mrgo-1-4" class="consigne hidden">
    ...
    <p>Le résultat de ce test est collectif et visible par les chercheurs. <br /><br />
        Autrement dit, seuls les chercheurs connaitront la performance collective des élèves de classe générale. Ainsi, ils compareront la performance collective des élèves de classe générale à celle des élèves de SEGPA. En revanche, personne ne connaitra ta performance personnelle (ni toi, ni les chercheurs) pourtant elle sera déterminante dans le résultat de ta classe.
